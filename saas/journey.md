...
| **자기 서버에 설치** | **0~2가 없습니다.** 관측 결과를 자기 DB에 넣고 4~6만 돕니다 — 러너도 토큰도 노드 카운터도 필요 없습니다 |
...
보안 검토이고, [러너 설계 §4](design.md)가 그 자리를 위해 쓰였습니다.
...
자리이고, 이 리포가 맡는 부분입니다([§1](../docs/design.md)).
...
여정의 각 단계가 어느 마일스톤에 걸려 있는지입니다. 순서는 [implementation.md](implementation.md)가
