...
| `PQCATON_EXPOSE_ADDR` | 기본 `off`. 노드 주소를 올릴지를 고객이 정합니다([§6.3.1](design.md)) |
...
| **주소 노출** | `PQCATON_EXPOSE_ADDR` 기본은 `off`입니다. 화면에서 IP로 노드를 보고 싶으면 `on`([§6.3.1](design.md)) |
