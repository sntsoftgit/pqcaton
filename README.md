...
하고, 이 리포는 그 관측을 **선언과 대조하고, 리뷰에 걸고, 확정합니다.**

**이름** — *pqcaton*(발음 **P-caton**) = **PQC** + **baton**(지휘봉). pqcota가 교향악의 *단원*이라면
이것은 지휘자가 쥐는 막대입니다. **지휘하는 것은 여전히 사람이고**, 이 도구는 그 손에 들립니다.

> **소스 공개(source-available)이지 오픈소스가 아닙니다.** [BUSL-1.1](LICENSE) — 관리 노드 5대까지
> 무료, 그 이상은 계약. **2030-08-11에 Apache-2.0으로 전환됩니다.** → [라이선스 안내](LICENSING.md)
...
[**BUSL-1.1**](LICENSE) · 2030-08-11에 Apache-2.0으로 전환됩니다.
