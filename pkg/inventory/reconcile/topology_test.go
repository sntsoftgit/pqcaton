...
func TestRenderTopologyDOT(t *testing.T) {
	edges := []ReconciledEdge{
		...
		{Key: ek("app", "undeclared", 22, "SSH"), State: Undeclared, Posture: discoveryv1.QuantumPosture_QUANTUM_POSTURE_CLASSICAL, Group: "ecdh"},
	...
	// 미관측 엣지는 UNDECLARED 굵은선(penwidth=3)으로 그리면 안 된다 — 점선이어야.
